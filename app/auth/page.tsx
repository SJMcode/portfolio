      ...
      <Card className="bg-white dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800 p-8 rounded-2xl shadow-xl">
        ...
        <CardContent className="p-0 pt-6">
          <form onSubmit={authMode === "login" ? handleSignIn : handleSignUp} className="space-y-4">
            {authMode === "signup" && (
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2.5 text-xs text-slate-950 dark:text-slate-100 outline-none focus:border-indigo-500 transition"
                  required
                />
              </div>
            )}
            ...
            >
              {isAuthLoading ? t("guestbook_submitting") : authMode === "login" ? t("guestbook_auth_login") : t("guestbook_register_btn")}
            </button>
